...
our %config = (
  ...
  openssldir => "",
  options => "enable-shared --cross-compile-prefix=arm-linux-gnueabihf- --prefix=/home/zhh/work/open_lib/openssl/openssl-openssl-3.0.6/build_328arm no-afalgeng no-asan no-asm no-async no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.22.1",
  perlargv => [ "linux-x86_64", "no-asm", "no-async", "-shared", "--cross-compile-prefix=arm-linux-gnueabihf-", "--prefix=/home/zhh/work/open_lib/openssl/openssl-openssl-3.0.6/build_328arm" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/zhh/work/open_lib/openssl/openssl-openssl-3.0.6/build_328arm",
  processor => "",
